 ...
 *
 * (C) COPYRIGHT International Business Machines Corp. 1993, 2021
 * All Rights Reserved
...
/* Options for SQL_ATTR_QUERY_PREFETCH */
#define SQL_QUERY_PREFETCH_OFF    0
#define SQL_QUERY_PREFETCH_ON     1
#define SQL_QUERY_PREFETCH_DEFAULT SQL_QUERY_PREFETCH_OFF
